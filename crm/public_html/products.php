            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <div class="row gutters-tiny">
                            ...
                            <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
                                <div class="block-content block-content-full block-sticky-options">
                                    ...
                                    <div class="py-20 text-center">
                                        <div class="font-size-h2 font-w700 mb-0 text-info" data-toggle="countTo" data-to="<?echo $count_g;?>">0</div>
                                        <div class="font-size-sm font-w600 text-uppercase text-muted">Всего товаров</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-3">
                            <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
                                <div class="block-content block-content-full block-sticky-options">
                                    ...
                                    <div class="py-20 text-center">
                                        <div class="font-size-h2 font-w700 mb-0 text-warning" data-toggle="countTo" data-to="0">0</div>
                                        <div class="font-size-sm font-w600 text-uppercase text-muted">Топ продаж</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                            ...
                            <a class="block block-rounded block-link-shadow" href="javascript:void(0)">
                                <div class="block-content block-content-full block-sticky-options">
                                    ...
                                    <div class="py-20 text-center">
                                        ...
                                        <div class="font-size-sm font-w600 text-uppercase text-muted">Мало на складе</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <!-- Add Product -->
                        <div class="col-md-6 col-xl-3">
                            <a class="block block-rounded block-link-shadow" href="product_add.php">
                                <div class="block-content block-content-full block-sticky-options">
                                    <div class="block-options">
                                        <div class="block-options-item">
                                    ...
                                    <div class="py-20 text-center">
                                        ...
                                        <div class="font-size-sm font-w600 text-uppercase text-muted">Новый товар</div>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="block-content">
                            ...
                            <table class="table table-borderless table-striped">
                                ...
                                <tbody>
                                    				...
                                    				$font='font-w600';
													include("lib/bd.php");
                                                	$result = mysqli_query($link,"SELECT * FROM Goods WHERE Importer_ID='$fimpid'");
                                                    while($item=mysqli_fetch_array($result))
                                                    {
                                                    		$status='';
                                                    		if($item['status_id']==1){
                                                    			$status="<span class='badge badge-secondary'>На проверке</span>";
                                                    		}
                                                    		if($item['status_id']==2){
                                                    		...
                                                    		$href='product_edit.php?id_g='.$item[ID];
