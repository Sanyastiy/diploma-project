    ...
    <body class="pagesbg">
            ...
            <main id="main-container">
                ...
                <div class="bg-body-light border-b">
                    <div class="content py-5 text-center">
                        <nav class="breadcrumb bg-body-light mb-0">
                            ...
                            <a class="breadcrumb-item" href="productsadm.php">Товары</a>
                ...
                <div class="content">
                    ...
                    <div class="row gutters-tiny">
                        ...
                        <div class="col-md-5">
                            <!-- Status -->
                            <form id="product_update" action="../product_edit.php" method="post" onsubmit="return false;">
                                <div class="block block-rounded block-themed">
                                    <div class="block-header bg-gd-primary">
                                        <h3 class="block-title">Статус товара</h3>
                                        <div class="block-options">
                                            <button type="submit" class="btn btn-sm btn-alt-primary">
                                                <i class="fa fa-save mr-5"></i>Сохранить
                                            </button>
                                    ...
                                    <div class="block-content block-content-full">
                                        <div class="form-group row">
                                            <label class="col-12" for="selectstat" >Категория</label>
                                            <div class="col-12">
                                                <!-- Select2 (.js-select2 class is initialized in Codebase() -> uiHelperSelect2()) -->
                                                <!-- For more info and examples you can check out https://github.com/select2/select2 -->
                                                <select class="js-select2 form-control" id="selectstat" name="selectstat" style="width: 100%;" data-placeholder=<?echo $cat?>>
                                                    <option value ="1">На проверку</option>
                                              ...
                                              <div class="form-group row">  
                                            <label class="col-12" for="reason">Причина</label>
                                            <div class="col-12">
                                                <textarea class="form-control" id="reason" name="reason" placeholder="Введите причину" rows="6"></textarea>
                                            </div>
        ...
        <script>
            ...
            $(document).ready(function() { 
                ...
                $("#category").click();
                $('#selectstat option[value="<?echo $status_id?>"]').prop('selected', true);
                $("#selectstat").click();
            }); 
        	...
        	$("#product_update").submit(function(){
        		...
        		var fstatus = $("#selectstat").val();//sub_catategory
    			...
    			$.ajax({
        			type: 'POST',
        			url: '..//lib/update.php',
        			data: "fid="+fid+"&fname="+fname+"&fcat="+fcat+"&fsubcat="+fsubcat+"&fstatus="+fstatus+"&fdesc="+fdesc+"&fcount="+fcount+"&fprice="+fprice+"&freason="+freason,
